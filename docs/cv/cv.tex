...
\section{Research\protect\footnote{Awarded the Qualcomm Innovation Fellowship}}

I am interested in automated reasoning, programming language theory, and formal
methods. Specifically, I am excited about useful languages that theoretically
and empirically lend themselves to efficient reasoning. All of my
publications---which are listed below---relate to this theme.

\nocite{*}
\printbibliography[heading=subbibliography,keyword={full},title={Refereed Conference Papers\protect\footnote{Denotes undergraduate research mentee}}]
...
{PLDI \textquotesingle23 USRC Winner}), Annamira O'Toole, Selina Kim, Nikhil Pimpalkhare (co-mentored with Elizabeth Polgreen)}
...
\begin{tblSection}{Awards and Distinctions\protect\footnote{Excluding awards from undergraduate studies or earlier}}{0.1}{0.85}
